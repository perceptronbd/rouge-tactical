  ...
  return (
    <div className="relative my-6 w-72">
      ...
      {label && (
        <label
          htmlFor={id}
          className="absolute text-base px-1 text-gray-500 duration-300 transform -translate-y-6 bg-white scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-accent-tertiary peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1 peer-focus:scale-75 peer-focus:-translate-y-7 peer-focus:bg-white"
        >
          {label}
        </label>
      )}
